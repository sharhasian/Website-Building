const institutions = [
  ["AXIS", "Cognitive systems, decision intelligence and the operating layer for higher performance."],
  ["CE Technologies", "Technology infrastructure, product engineering and intelligent systems."],
  ["Catalyst Alpha Group", "Venture building, strategy and institutional growth."],
  ["Catalyst Empire FZCO", "Private capital, global markets and disciplined client stewardship."],
  ["Catalyst Monarch", "Brand, design and creative execution across the ecosystem."],
];

const principles = [
  ["01", "Clarity", "Eliminate noise. Understand what matters."],
  ["02", "Discipline", "Build the process before chasing the outcome."],
  ["03", "Intelligence", "Combine evidence, context and judgment."],
  ["04", "Execution", "Turn insight into deliberate action."],
  ["05", "Legacy", "Build systems that outlive the moment."],
];
  ...
  return (
    <>
      <header className="nav">
        <a className="brand" href="#top">S.M.H.</a>
      ...
      <main id="main">
        <section className="hero" id="top">
          ...
          <div className="heroCopy">
            ...
            <p className="dek">Founder. Builder. Systems architect.<br />Creating institutions where intelligence compounds.</p>
        ...
        <section className="opening" id="story">
          ...
          <div className="openingGrid">
            ...
            <div className="bodyCopy">
              <p className="lead">I do not believe the future belongs to the loudest person in the room. It belongs to the person who can see clearly, decide deliberately and execute when conditions are uncertain.</p>
              <p>My work sits at the intersection of markets, psychology, technology and systems. Across every venture, the objective is the same: turn fragmented information into a disciplined advantage without surrendering judgment, privacy or control.</p>
            </div>
          </div>
        ...
        <section className="axis" id="axis">
          ...
          <div className="axisStatement">A private intelligence environment built to help people think deeper, decide wiser and execute better.</div>
          <div className="axisVisual">
            <div className="orb"><span>A</span></div>
            <div className="axisRail left"><b>STOIC</b><b>STRATEGIC</b><b>SCIENTIFIC</b></div>
            <div className="axisRail right"><b>BEHAVIORAL</b><b>SYSTEMS</b><b>PROBABILISTIC</b></div>
          </div>
          <div className="axisFooter"><span>Signal</span><span>Reasoning</span><span>Markets</span><span>Portfolio</span><span>Memory</span><span>Research</span></div>
        </section>
      ...
      <footer><div className="brand">S.M.H.</div><p>Founder headquarters for Shahriar M. Hasian.</p><div><a href="#axis">AXIS</a><a href="#ecosystem">Ecosystem</a><a href="#contact">Contact</a></div><small>© 2026. All rights reserved.</small></footer>
    </>
  );
}
